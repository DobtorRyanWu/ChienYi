...
**產出日期**：2026-04-20
**適用模組**：`E:\work\system\addons\dobtor_doc_editor`
**當前基礎**：Odoo 18 Owl Component + @hufe921/canvas-editor + canvas-editor-plugin-docx（跑版嚴重）
...
```
[ ] 把 Downloads/dobtor_doc_editor 複製成 dobtor_doc_editor_v3
...
**Document End** — 版本 1.0 / 2026-04-20
