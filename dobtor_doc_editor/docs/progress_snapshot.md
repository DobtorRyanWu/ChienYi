...
## 1. 當前指標一覽（Sprint 177 結尾）

| 指標 | 數值 |
|---|---|
| vitest | **1464 passed + 1 skipped**（Sprint 177 +5 ParagraphParser 註解錨點；Sprint 176 +9；Sprint 175 +5） |
| VR mean | **0.073191**（Sprint 65 promote、第 37 次連續 byte-identical；Sprint 167-177 textAlignment / framePr / background / watermark / 追蹤修訂 / 註解 皆 Strategy C 或 capture-only、42 fixture byte-identical） |
