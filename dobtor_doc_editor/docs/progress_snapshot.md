...
## 1. 當前指標一覽（Sprint 178 結尾）

| 指標 | 數值 |
|---|---|
| vitest | **1468 passed + 1 skipped**（Sprint 178 +4 BackgroundParser themeColor；Sprint 177 +5；Sprint 176 +9） |
| VR mean | **0.073191**（Sprint 65 promote、第 38 次連續 byte-identical；Sprint 167-178 textAlignment / framePr / background / watermark / 追蹤修訂 / 註解 皆 Strategy C 或 capture-only、42 fixture byte-identical） |
