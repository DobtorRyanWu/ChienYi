...
## 1. 當前指標一覽（Sprint 207 結尾 — Phase 6 ChienYi 真實 fixture 文字 SHA-256 全 100% byte-identical 對齊）

| 指標 | 數值 |
|---|---|
| vitest | **1963 passed + 1 skipped**（`npm test` 全套口徑；Sprint 207 +1 sprint207 text preservation audit）。註：Sprint 178 以前記錄的「1468」為不同計數口徑、自 Sprint 179 起改採全套數字 |
...
| Sprint audit doc | 207（最新 sprint207_chienyi_text_preservation_audit.md；159 / 160v1 為 docs-only follow-up、無獨立 audit doc） |
