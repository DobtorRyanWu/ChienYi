...
| 47 | **zip bomb/上傳大小防護**：PackageReader 壓縮30MB/解壓300MB/part 8000 上限 + 前端 file.size 把關；最大真實檔 2.3MB 有 13× 餘裕 | [sprint47_security_guards.md](sprint47_security_guards.md) |
